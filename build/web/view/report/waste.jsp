                        ...
                        <div class="aaa" >
                            ...
                            <div class="card-body">
                                ...
                                <table id="datatablesSimple" class="table-bordered">
                                    ...
                                    <tbody>
                                        <%for (ReportInventory s : salaries) {%>
                                        <tr>
                                            <td scope="col"><%=s.getBill().getBid()%></td>
                                            <td scope="col"><%=s.getBill().getCname()%></td>
                                            <td scope="col"><%=s.getBill().getUnitPrice()%> (VNĐ)</td>
                                            <td scope="col"><%=s.getRemoved()%> (Linh kiện)</td>
                                            <td scope="col"><%=s.getBill().getUnitPrice()*s.getRemoved()%> (VNĐ)</td>
                                        </tr>
                                        
                                        <%}%>
                                        <tr>
                                            <th scope="col" colspan="5" style="text-align: center">Tổng: <%=total%> (VNĐ)</th>
                                        </tr>
                                    </tbody>
