...
<html lang="en">
    <head>
        ...
        <title>Báo cáo | Lãng phí</title>
        <link href="https://cdn.jsdelivr.net/npm/simple-datatables@latest/dist/style.css" rel="stylesheet" />
        <link href="../asset/css/style.css" rel="stylesheet" />
        <link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">

        <%
            ArrayList<ReportInventory> salaries = (ArrayList<ReportInventory>) request.getAttribute("wastes");
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <div class="form-agline">
                ...
                <form action="waste" method="GET" id="search-month">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Báo cáo chi phí lãng phí</li>
                        </ol>
                        <%if (ym.getYear() == 1) {%>
                        <div class="row">
                                ...
                                <div class="card bg-warning text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="http://localhost:8080/ProductionManager/report/salary">
                                            <fmt:setLocale value = "vi_VN"/>
                                            <fmt:formatNumber type="currency" value="${requestScope.totalSalaries}" />
                        ...
                        <div class="aaa" >
                            <div class="card-header">
                                ...
                                <%if (ym.getYear() != 1) {%>
                                Bảng báo cáo lãng phí tháng <%=ym.getMonth().getValue()%> năm <%=ym.getYear()%>
                                <%} else {%>
                                Bảng báo cáo lãng phí từ trước đến nay.
                                <%}%>
                                ...
                                <table id="datatablesSimple" class="table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">lãng phí</th>

                                        </tr>
                                    </thead>

                                    <tbody>
                                        <c:forEach items="${requestScope.wastes}" var="s">


                                            <tr>
                                                <td scope="col">${s.bill.bid}</td>
                                                <td scope="col">${s.bill.cname}</td>
                                                <td scope="col">
                                                    <fmt:setLocale value = "vi_VN"/>
                                                    <fmt:formatNumber type="currency" value="${s.bill.unitPrice}" />

                                                </td>
                                                <td scope="col">${s.removed}</td>
                                                <td scope="col">
                                                    <fmt:setLocale value = "vi_VN"/>
                                                    <fmt:formatNumber type="currency" value="${s.removed * s.bill.unitPrice}" />
