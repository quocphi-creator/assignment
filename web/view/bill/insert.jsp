            ...
            <form action="insert" method="POST">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="bid" class="form-control" placeholder="Nhập mã đơn hàng">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="cname">Tên linh kiện</label>
                        <input type="text" name="cname" class="form-control" placeholder="Nhập tên linh kiện">
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="unitprice" class="form-control" placeholder="Đơn giá">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="total">Thanh toán</label>
                        <input type="text" name="total" class="form-control" placeholder="Nhập số tiền">
                    </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" name="inputDate" class="form-control" placeholder="Chọn ngày">
                    </div>
                    <div class="form-group col-md-6">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="contact" class="form-control" placeholder="Thông tin liên hệ">
                    </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <input type="text" name="address" class="form-control" placeholder="Địa chỉ nhà cung cấp">
                    </div>
